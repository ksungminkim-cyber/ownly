...
export const viewport = {
  width: "device-width",
  initialScale: 1,
  // ✅ user-scalable 제거 — 구글 모바일 SEO 감점 항목
};
                ...
                mainEntity: [
                  {
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "기본 플랜은 무료입니다. 물건 3개, 세입자 5명까지 영구 무료로 사용할 수 있습니다.",
                    },
                  },
                  {
                    "@type": "Question",
                    name: "임대 관리를 어떻게 시작하나요?",
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "회원가입 후 물건을 등록하면 수금 현황, 계약 관리, 캘린더 등 모든 기능을 바로 사용할 수 있습니다.",
                    },
                  },
                  {
                    "@type": "Question",
                    name: "상가와 주거 모두 관리할 수 있나요?",
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "네. 아파트·빌라·오피스텔·상가·토지 등 모든 임대 유형을 통합 관리할 수 있습니다.",
                    },
                  },
                  {
                    "@type": "Question",
                    name: "내용증명을 직접 작성할 수 있나요?",
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "네. 임대료 미납, 계약 위반, 계약 해지 등 6가지 사유별 법적 서식을 자동 생성하고 PDF로 다운로드할 수 있습니다.",
                    },
                  },
                  {
                    "@type": "Question",
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "종합소득세·부가세를 자동 추정하는 세금 시뮬레이터를 제공합니다. 최신 세법 기준으로 계산됩니다.",
                    },
                  },
                  {
                    "@type": "Question",
                    name: "카카오톡으로 수금 알림을 보낼 수 있나요?",
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "PRO 플랜에서 카카오 알림톡으로 미납·납부예정·계약만료 알림을 세입자에게 직접 발송할 수 있습니다.",
                    },
                  },
                ],
              },
