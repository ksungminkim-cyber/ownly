...
const STEPS = [
  { id: "welcome", emoji: "👋", title: "온리에 오신 걸 환영합니다", subtitle: "내 임대 물건, 온리 하나로", desc: "수금부터 계약·세금·내용증명까지\n임대 관리에 필요한 모든 것을 한 곳에서.", cta: "시작하기", skip: false },
  { id: "register", emoji: "🏠", title: "첫 물건을 등록해보세요", subtitle: "2분이면 충분합니다", cta: "물건 등록하기", skip: true },
  { id: "done", emoji: "🎉", title: "준비 완료!", subtitle: "이제 관리를 시작하세요", desc: "세입자를 연결하고 수금 현황을 추적하면\n미납 알림과 계약 만료 알림을 자동으로 받을 수 있어요.", cta: "대시보드로 이동", skip: false },
];
