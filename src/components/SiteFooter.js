...
export default function SiteFooter({ hasFixedBar = false }) {
  return (
    <footer style={{
      ...
      padding: hasFixedBar ? "20px 32px 72px" : "20px 32px 28px",
    }}>
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12, marginBottom: 14 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ fontSize: 11, color: "#b0b0be", marginLeft: 2 }}>내 임대 물건, 온리 하나로</span>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
            {[
              ...
              <Link key={l.label} href={l.href}
                style={{ fontSize: 12, color: "#8a8a9a", textDecoration: "none" }}
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
          <div style={{ fontSize: 11, color: "#a0a0b0", lineHeight: 1.9, display: "flex", flexWrap: "wrap", gap: "0 16px" }}>
          ...
          <span style={{ fontSize: 11, color: "#b0b0be", whiteSpace: "nowrap" }}>© 2025 McLean Inc.</span>
        </div>
