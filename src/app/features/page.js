...
export const metadata = {
  ...
  description: "Ownly의 모든 기능을 확인하세요. 임대료 수금 자동화, 계약서 관리, 내용증명, 세금 시뮬레이터, AI 입지 분석, 수익률 계산까지 임대인에게 필요한 모든 도구.",
...
const FEATURES = [
  ...
  },
  {
    slug: "ai-analysis",
    title: "AI 입지·임대료 분석",
    keywords: ["AI 부동산 분석", "적정 임대료", "입지 분석", "국토부 실거래가"],
    desc: "국토교통부 실거래가 데이터를 기반으로 해당 지역의 적정 임대료를 AI가 분석합니다. 면적별 임대료 시나리오, 시세 구간 분석, 교통·학군·상권 등 입지 요소를 종합 평가합니다.",
    details: ["국토교통부 실거래가 기반 분석", "면적별 임대료 시나리오 테이블", "상권·교통·학군 입지 점수", "시장 포지션 및 공실 리스크 평가"],
  },
  {
