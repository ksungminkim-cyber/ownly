        ...
        <div style={{ maxWidth: 760, margin: "56px auto 0" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 32 }}>
            {[
              ...
              { q: "이 생성기는 정말 무료인가요?", a: `네, 작성과 미리보기·워터마크 인쇄는 회원가입 없이 무료입니다. 워터마크 없는 정식 PDF는 무료 가입 후 월 ${EARLY_ACCESS_CERTIFIED_FREE}건까지 무료이고, 그 이상은 얼리 서포터 구독(플러스 플랜 월 ${EARLY_SUPPORTER.price.toLocaleString()}원, ${EARLY_SUPPORTER.lockMonths}개월 가격 고정)에서 무제한 발급됩니다. 가입 버튼을 누르면 지금 작성한 내용이 그대로 이어집니다.` },
            ].map((f) => (
