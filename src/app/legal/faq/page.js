...
const FAQS = [
  {
    ...
    items: [
      ...
      {
        q: "무료로 사용할 수 있나요?",
        a: "네, 무료 플랜을 제공합니다. 무료 플랜은 물건 3개, 세입자 5명까지 등록할 수 있습니다. 더 많은 물건과 기능이 필요하시면 플러스(월 9,900원) 플랜으로 업그레이드하실 수 있습니다. 유료 플랜은 플러스 하나이며 언제든 해지할 수 있습니다.",
      },
      {
        q: "데이터는 어디에 저장되나요?",
  ...
  },
  {
    ...
    items: [
      {
        q: "결제 수단은 무엇을 지원하나요?",
        a: "카카오페이 정기결제(카카오톡 간편결제에 등록된 카드·카카오페이머니)를 지원합니다. 결제는 카카오페이를 통해 안전하게 처리됩니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "세금 시뮬레이터는 화면에 표시된 기준 연도와 입력값을 바탕으로 한 참고용 추정치를 제공합니다. 실제 세액은 개인 상황과 최신 법령에 따라 다를 수 있으므로, 신고·납부 전에는 홈택스 또는 세무 전문가를 통해 확인해 주세요.",
      },
      {
