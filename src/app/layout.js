...
export const metadata = {
  ...
  verification: {
    // google: "구글서치콘솔에서 발급받은 코드를 여기에 입력하세요",
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
          {
            ...
            screenshot: "https://www.ownly.kr/og-image.png",
          ...
          },
          {
            ...
            name: "McLean",
            url: "https://www.ownly.kr",
            logo: "https://www.ownly.kr/favicon.svg",
            sameAs: [],
            contactPoint: { "@type": "ContactPoint", email: "inquiry@mclean21.com", contactType: "customer support" }
          },
          {
            "@context": "https://schema.org",
            "@type": "WebSite",
            ...
            potentialAction: {
              "@type": "SearchAction",
              target: "https://www.ownly.kr/dashboard/community?q={search_term_string}",
          ...
          },
          {
            ...
            "@type": "FAQPage",
            mainEntity: [
              { "@type": "Question", name: "Ownly는 무료인가요?", acceptedAnswer: { "@type": "Answer", text: "기본 플랜은 무료입니다. 물건 2개, 세입자 3명까지 영구 무료로 사용할 수 있습니다." } },
              ...
              { "@type": "Question", name: "세금 신고에 도움이 되나요?", acceptedAnswer: { "@type": "Answer", text: "종합소득세·부가세를 자동 추정하는 세금 시뮬레이터를 제공합니다. 2025년 세법 기준으로 계산됩니다." } }
            ]
          }
        ])}} />
      </head>
