import "./globals.css"; import { ThemeProvider } from "../context/ThemeContext"; import KakaoChannelButton from "../components/KakaoChannelButton"; import AttributionCapture from "../components/AttributionCapture"; export const viewport = { width: "device-width", initialScale: 1, themeColor: "#1a2744", }; export const metadata = { metadataBase: new URL("https://www.ownly.kr"), title: { default: "온리(Ownly) - 임대 관리 · 내용증명·수익률 계산 무료 | 임대인 통합 서비스", template: "%s | 온리(Ownly)", }, description: "내용증명 작성·월세 시세 조회·수익률 계산을 무료로. 수금·계약·세금까지 임대인 업무를 한 곳에서 관리하는 임대 물건 관리 서비스. 부동산 매매·임대·중개와 무관.", keywords: ["온리","Ownly","내용증명 작성","월세 미납 내용증명","월세 시세","전월세 실거래가","임대소득세 계산","임대 수익률 계산기","공실 관리","임대 물건 관리","수금 관리","계약 만료 알림","세금 시뮬레이터","건물주 관리","임대인 필수 앱"], authors: [{ name: "McLean", url: "https://www.ownly.kr" }], manifest: "/manifest.json", icons: { icon: [ { url: "/favicon.svg", type: "image/svg+xml" }, { url: "/icon-192.png", sizes: "192x192", type: "image/png" }, ], apple: [{ url: "/apple-touch-icon.png", sizes: "180x180" }], }, appleWebApp: { capable: true, title: "온리", statusBarStyle: "default" }, openGraph: { type: "website", locale: "ko_KR", url: "https://www.ownly.kr", siteName: "온리(Ownly)", title: "온리(Ownly) - 임대 물건 관리 서비스", description: "임대인을 위한 임대 물건 관리 서비스. 수금·계약·세금·내용증명까지 월 구독으로 제공. 부동산 매매·임대·중개와 무관.", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "온리(Ownly) - 임대 물건 관리 서비스" }], }, twitter: { card: "summary_large_image", title: "온리(Ownly) - 임대 물건 관리 서비스", description: "임대인용 임대 물건 관리 서비스 플랫폼 (월 구독)", images: ["/opengraph-image"], }, robots: { index: true, follow: true }, alternates: { canonical: "https://www.ownly.kr" }, verification: { naver: "841eaee5d6c77a899f34fa724e517995d65f3180" }, };
